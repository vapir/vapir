...
#    include Vapir::Dialog
    ...
    def test_alert
        ...
        assert_match(/Press OK\z/, browser.modal_dialog.text)
        browser.modal_dialog.click_button('OK')
        assert_equal(browser.text_field!(:id, "testResult").value , "You pressed the Alert button!")
        
        browser.button!(:id, "btnAlert").click_no_wait
        assert_match(/Press OK\z/, browser.modal_dialog.text) # this is "[JavaScript Application]Press OK" on mac
        browser.modal_dialog.click_button('OK')
        assert_equal(browser.text_field!(:id, "testResult").value , "You pressed the Alert button!")
    end
    ...
    def test_confirm_ok
        ...
        assert_match(/Press a button\z/, browser.modal_dialog.text) # "[JavaScript Application]Press a button" on mac
        browser.modal_dialog.click_button('OK')
        assert_equal(browser.text_field!(:id, "testResult").value , "You pressed the Confirm and OK button!")

        browser.button!(:id, "btnConfirm").click_no_wait
        assert_match(/Press a button\z/, browser.modal_dialog.text)
        browser.modal_dialog.click_button('OK')
        assert_equal(browser.text_field!(:id, "testResult").value , "You pressed the Confirm and OK button!")
    end
