...
class TC_TableCell_XPath < Test::Unit::TestCase
  ...
  def testCellExists
    ...
    assert_nil( browser.table_cell(:xpath , "//img[@src='images\/rectangle.jpg']/../")  )
  ...
  def testCell_properties
    assert_equal(1 , browser.table_cell!(:xpath , "//img[@src='images\/square.jpg']/../").colspan) 
    assert_equal(2 , browser.table_cell!(:xpath , "//img[@src='images\/triangle.jpg']/../").colspan) 
    assert_equal(3 , browser.table_cell!(:xpath , "//img[@src='images\/circle.jpg']/../").colspan) 
